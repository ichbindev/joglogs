...
<h5>All sections of these Terms of Use that, by their nature, should survive termination will survive termination, including, without limitation, the sections entitled User Content, Indemnity, Disclaimer of Warranty and Limitation of Liability, and General.</h5>

           <h2> Introduction</h2>
<p>The Train Method.com website and mobile application is an online mechanism for tracking, managing, and sharing all of your fitness activities. It is provided to you by Solaris Equity Holdings, Inc. ("us" or "we" or "our" or "Solaris Equity Holdings"), in connection with our partners, service providers, sponsors, or other affiliates. So that we may safely and responsibly manage this site for all of our users, your use of this site is subject to certain terms and conditions. The terms and conditions set forth below ("Terms of Use") apply to your use of the services and functionality provided on or through the Train Method.com site and mobile application (the "Services").</p>

            <p>By accessing and using the Services, you acknowledge that you have read, understood, and agree to be bound by these Terms of Use. If you do not accept these Terms of Use, you are not authorized to use the Services. We may modify these Terms of Use at any time and such modification will be effective upon posting to the Services.</p>

            <h2>Use of the Services</h2>
<p>The Services allow for the delivery of software, text, graphics, images, video, audio, data and other material (collectively referred to as the "Content"). The Content may be owned by us or may be provided through an arrangement we have with others, including other users of the Services, or our partners, sponsors, or affiliates. The Content is protected by copyright under both United States and foreign laws. Unauthorized use of the Content may violate copyright, trademark, and other laws. You have no rights in or to the Content, and you may not use the Content except as permitted under these Terms of Use. No other use is permitted without prior written consent from us or the owner of the Content. You must retain all copyright and other proprietary notices contained in the original Content on any copy you make of the Content. You may not sell, transfer, assign, license, sublicense, or modify the Content or reproduce, display, publicly perform, make a derivative version of, distribute, or otherwise use the Content in any way for any public or commercial purpose, except to utilize features of the Services that, by their nature, involve publishing or sharing of Content with the public. If you violate any part of these Terms of Use, your permission to access and/or use the Content and Services automatically terminates and you must immediately destroy any copies you have made of the Content.</p>

              <p>Various company, product, and service names displayed on the Services may be trademarks or service marks owned by others (the "Third-Party Trademarks"). Your use of the Services should not be construed as granting, by implication, estoppel, or otherwise, any license or right to use any Third-Party Trademark displayed on this Services. The Third-Party Trademarks may not be used to disparage any applicable third-party, any of their products or services, or in any manner in which, in our reasonable judgment, may damage any goodwill in the Third-Party Trademarks.</p>

              <p>The Services may include access to links to, and content and data from, third-party websites ("External Services"). These links, content, and data are provided solely as a convenience to you and not as an endorsement, sponsorship, or recommendation by us of the content on such External Services. The content of such External Services is developed and provided by others. In addition, the Services permit access to content posted, stored, or displayed at the direction of users of the Services, for which we cannot accept any responsibility or liability.</p>

              <p>The Services are for personal use only and may not be used in connection with any commercial endeavors except those that are specifically approved by us. The following activities are expressly prohibited: (i) collecting usernames and/or email addresses of other users by electronic or other means for the purpose of sending unsolicited email or other communications, (ii) any use of the Services, which in our sole judgment, degrades the reliability, speed, or operation of the Services or any underlying hardware or software thereof, (iii) use of web scraping, web harvesting, or web data extraction methods from Joglogs even if the Joglogs account owner gives permission; and (iv) any use of the Services which is unlawful or in violation of these Terms of Use.</p>

              <p>By using the Services, you represent and warrant that you are 13 years of age or older, and if you are located in the European Union that you are 16 years of age or older.</p>
...
<ul>
            ...
            <li>(iv) Information reasonably sufficient to permit us to contact you, such as an address, telephone number, and, if available, an electronic mail address;</li>

            <li>(v) A statement that you have a good faith belief that use of the material in the manner complained of is not authorized by the copyright owner, its agent, or the law; and</li>
            ...
            <li>(vi) A statement that the information in the notification is accurate, and under penalty of perjury, that you are authorized to act on behalf of the owner of an exclusive right that is allegedly infringed.</li>
              ...
              <p>Our designated Copyright Agent to receive notifications of claimed infringement and other notices relating to User Content and/or violation of these Terms of Use (e.g., violations of criminal laws) is: Email: support@Train Method.com. For clarity, only DMCA notices and notices relating to complaints in connection with User Content or violations of these Terms of Use should go to the Copyright Agent; any other feedback, comments, requests for technical support, and other communications should be addressed to our standard support contacts as identified on the Services.</p>

              <h2>Online Privacy Policy</h2>

<p>Your privacy is important to us. To better protect your privacy, we provide a notice explaining our online information practices and the choices you can make about the way your personal information is collected and used through the Services. Our online privacy policy is available for viewing at https://Train Method.com/privacypolicy.</p>
...
<p>WE, OUR AFFILIATES, OUR PARTNERS, AND OUR AND THEIR RESPECTIVE OFFICERS, DIRECTORS, EMPLOYEES, AGENTS, SUPPLIERS, OR LICENSORS, MAKE NO WARRANTIES OR REPRESENTATIONS ABOUT THE CONTENT (INCLUDING THE USER CONTENT), INCLUDING BUT NOT LIMITED TO ITS ACCURACY, RELIABILITY, COMPLETENESS, TIMELINESS, OR RELIABILITY.</p>
...
<p>These Terms of Use, and any rights and licenses granted hereunder, may not be transferred or assigned by you, but may be assigned by us without restriction.</p>
              ...
              <p>These Terms of Use are governed by the internal substantive laws of the Commonwealth of Massachusetts, without respect to its conflict of law provisions. You expressly agree to submit to the exclusive personal jurisdiction of the state and federal courts sitting in the City of Boston in the Commonwealth of Massachusetts. Any alleged claim or cause of action you may have with respect to your use of the Site must be commenced within 1 year after the alleged claim or cause of action arises. If any provision of these Terms of Use is found to be invalid by any court having competent jurisdiction, the invalidity of such provision will not affect the validity of the remaining provisions of the Terms of Use, which will remain in full force and effect. All sections of these Terms of Use that, by their nature, should survive termination will survive termination, including, without limitation, the sections entitled User Content, Indemnity, Disclaimer of Warranty and Limitation of Liability, and General. Failure by us to act on or enforce any provision of the Terms of Use will not be construed as a waiver of that provision or any other provision in these Terms of Use. No waiver will be effective against us unless made in writing, and no such waiver will be construed as a waiver in any other or subsequent instance. Except as expressly agreed by us and you, these Terms of Use constitute the entire agreement between you and us with respect to the subject matter, and supersede all previous or contemporaneous agreements, whether written or oral, between the parties with respect to the subject matter. The section headings are provided merely for convenience and will not be given any legal import. These Terms of Use will inure to the benefit of our successors, assigns, licensees, and sublicensees.</p>

              <h2>Train Method Supplementary Terms and Conditions</h2>
<p>The Services may also include access to certain optional features and services for reporting and managing fitness data (the "Train Method"). The Train Method service is a collection of premium services that are available only under these Supplementary Terms and Conditions in addition to the Terms of Use (collectively, the "Agreement") and subject to your payment of the fees referenced below. By signing up for the Train Method service through your account settings page, you acknowledge and agree to the terms and conditions in this Agreement.</p>

<h2>Train Method service Termination</h2>
<p>You may terminate this Agreement at any time by canceling your subscription through your accounts settings page. There are no refunds for any fees paid. YOU ARE RESPONSIBLE FOR TERMINATING YOUR ACCOUNT AND THIS AGREEMENT AND WE ARE NOT RESPONSIBLE FOR YOUR FAILURE TO PROPERLY TERMINATE YOUR SERVICE AND THIS AGREEMENT NOR FOR ANY CREDIT CARD CHARGES AND FEES YOU INCUR AS A RESULT OF YOUR FAILURE TO PROPERLY TERMINATE YOUR SERVICE AND THIS AGREEMENT.</p>

              <p>We may terminate this Agreement, disable your account, and/or put your account on inactive status, in each case at any time with reasonable cause or violation to these terms of service agreement, and with or without notice. We will have no liability to you or any third party because of such termination or action.</p>

              <h2> Fees for the Train Method monthly service</h2>
<p>If you opt to sign up for the Train Method service monthly subscription plan, you will be subject to monthly subscription fees in accordance with the Fee Schedule and related information (the "Fee Schedule"). You will be required to submit payment monthly in advance for access to the Train Method service. Access to the Train Method service will be disabled until payment is received. Fees will be billed monthly on an ongoing and recurring basis even if you are not actively using the Train Method service.</p>

<h2>Fees for the Train Method annual service</h2>
<p>If you opt to sign up for the Train Method service annual subscription plan you will be subject to annual subscription fees in accordance with the Fee Schedule and related information (the "Fee Schedule"). You will be required to submit payment annually in advance for access to the Train Method service. Access to the Train Method service will be disabled until payment is received. Fees will be billed annually on an ongoing and recurring basis even if you are not actively using the Train Method service.</p>

<h2> Fee Schedule; Discounts.</h2>
<p>You are responsible for reviewing the Fee Schedule from time to time and remaining aware of the fees charged by us and any applicable discounts. The Fee Schedule, including subscriber or any discounts, is subject to change at any time in our sole discretion. We will use good faith efforts to notify you prior to the effectiveness of any significant change to the Fee Schedule.</p>

<h2> Payment.</h2>
<p>Payment for the Train Method service will be made by a valid credit card or Paypal® accounts accepted by us. Fees are payable in U.S. dollars. You hereby authorize us to charge your credit card for such amounts on a regular monthly or yearly basis beginning at the beginning of your subscription and continuing until such time as your account is terminated. If we are for any reason unable to effect automatic payment via your credit card, we will attempt to notify you via email and your subscription will be disabled until payment is received. Amounts paid for the Train Method service, including prepayments, are not refundable.</p>

<h2> Fee Schedule</h2>
<p>Your Fee Schedule is located in the Subscriptions tab in the account settings under "billing dates". The Fee Schedule displays the estimated next billing date and amount for your FitnessReport service will be displayed.</p>

<h2>Train Method Gifting</h2>
<p>Gifts will be redeemable for seven years from the date at which they were purchased. Gift Cards do not assess any service fees for non-use. To obtain your balance on a Gift Card, please visit support.Train Method.com. Gift Cards can only be used online at https://Train Method.com/go. Gift Cards will not be replaced or refunded if lost or stolen. Solaris Equity Holdings, Inc. and its affiliates are not responsible for lost Gift Cards. Gift Cards will not be returnable or exchangeable for cash, except in states where required by law. Coupons and other discounts may not be used to purchase Gift Cards. For additional questions, please contact support@Train Method.com.</p>
