...
<p>All sections of these Terms of Use that, by their nature, should survive termination will survive termination, including, without limitation, the sections entitled User Content, Indemnity, Disclaimer of Warranty and Limitation of Liability, and General.</p>
           ...
           <h4> Introduction</h4>
<p>The training-method.com website and mobile application is an online mechanism for tracking, managing, and sharing all of your fitness activities. It is provided to you by Solaris Equity Holdings, Inc. ("us" or "we" or "our" or "Solaris Equity Holdings"), in connection with our partners, service providers, sponsors, or other affiliates. So that we may safely and responsibly manage this site for all of our users, your use of this site is subject to certain terms and conditions. The terms and conditions set forth below ("Terms of Use") apply to your use of the services and functionality provided on or through the training-method.com site and mobile application (the "Services").</p>
...
<p>These Terms of Use, and any rights and licenses granted hereunder, may not be transferred or assigned by you, but may be assigned by us without restriction.</p>
              ...
              <h4>Joglogs Go Supplementary Terms and Conditions</h4>
...
<h4>Joglogs Go service Termination</h4>
...
<h4>Joglogs Go Gifting</h4>
<p>Gifts will be redeemable for seven years from the date at which they were purchased. Gift Cards do not assess any service fees for non-use. To obtain your balance on a Gift Card, please visit support.training-method.com. Gift Cards can only be used online at https://training-method.com/go. Gift Cards will not be replaced or refunded if lost or stolen. Solaris Equity Holdings, Inc. and its affiliates are not responsible for lost Gift Cards. Gift Cards will not be returnable or exchangeable for cash, except in states where required by law. Coupons and other discounts may not be used to purchase Gift Cards. For additional questions, please contact support@training-method.com.</p>
