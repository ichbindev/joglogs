...
let gmail="perrywilliams@800appliance.com";
let events = [];
events.push({
  number: "3",
  ...
  milesToRunToday: "2.3",
  mileTotalThisWeek: "18",
  title: "2.3 mile run today. 16 weeks til Marathon. ",
  description: "Easy Run Day, 1/8th of your weekly Run"
});

events.push({ number: '4',
  date: '2019-11-22T18:00:00.000Z',
  percentMilesPerWeek: '50',
  milesToRunToday: '9',
  mileTotalThisWeek: '18',
  title: '9 mile run today. 16 weeks til Marathon. ',
  description: 'Long Run Day, 50% of Total Week Run',
});

createCalendar(gmail,events);
